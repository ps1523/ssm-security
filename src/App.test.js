      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white text-center">
            ...
            <p className="text-blue-100">Login to your SSM Security account</p>
          </div>
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white text-center">
            ...
            <p className="text-purple-100">Join SSM Security Services</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setCurrentPage('home')}>
              ...
              <div>
                <div className="text-2xl font-bold">SSM Security</div>
                <div className="text-xs text-blue-200">Security Services Management</div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">SSM Security</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <p className="flex items-center"><MapPin className="w-4 h-4 mr-2" /> Chennai, Tamil Nadu</p>
                <p>Email: info@ssmsecurity.com</p>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 SSM Security Services Management. All rights reserved.</p>
          </div>
        </div>
      </footer>
      )}
...
export default SSMSystem;import React, { useState, useEffect } from 'react';